...
from network.modules import SPVCNN
from network.gru_fusion import GRUFusion

from ops.back_projcet import back_project
...
class NeuConNet(nn.Module):
    ...
    def compute_loss(self,tsdf, occ, tsdf_target, occ_target, loss_weight = (1,1), mask = None, pos_weight = 1.0):
